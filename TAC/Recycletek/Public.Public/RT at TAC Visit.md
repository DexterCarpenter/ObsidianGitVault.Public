...
- [ ] Drawing edits
	- [ ] sheet for rear holes
	- [ ] sheet for Eye bolt under roll up door
...
- [ ] EcoCount Carriage
	- [ ] TBD changes from design review
		- [ ] Hinge size change? -- no
		- [ ] Hinge offset -- change to 4x3 tube
		- [ ] additional rollers? - no
			- [ ] lengthen friction plate & add tube supports
		- [ ] Remove C Channel -- add .25 bar stock 5" wide
	- [ ] weld hinge mount plate -- no more mounting plate because 4x3 tube now
	- [ ] Black powdercoat - frame yes, hinges no
	- [ ] Change Hinge location pattern
	- [ ] add jack hole pattern & access hole
- [ ] DropDoor
	- [ ] Which Gas struts are we using -- we don't 
	...
	- [ ] need design for back elec cover - need one for prototypes and one for future versions | prototype is plastic
- [ ] Misc.
